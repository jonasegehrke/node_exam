...
var app = (function () {
    ...
    function instance$d($$self, $$props, $$invalidate) {
    	...
    	const data = {
    		labels: ['Fravær', 'Samlede antal Lektioner'],
    		datasets: [
    			{
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "from-other svelte-qaplue");
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "from-you svelte-qaplue");
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "svelte-1dqg5f2");
    			add_location(input, file$3, 26, 0, 938);
    			attr_dev(div, "id", "datalist");
    			attr_dev(div, "class", "svelte-1dqg5f2");
    			add_location(div, file$3, 33, 0, 1059);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(input, "input", getSearchResults, false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop$1,
    ...
    async function getSearchResults() {
    	...
    	respData.data.forEach(student => {
    		...
    		option.addEventListener("click", () => {
    			...
    			document.getElementById("search").value = student.firstName + " " + student.lastName;
    			document.getElementById("datalist").innerHTML = "";
    		});
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<SearchSelect> was created with unknown prop '${key}'`);
    	});

    	$$self.$capture_state = () => ({ getSearchResults });
    	return [];
    }
    ...
    function create_fragment$2(ctx) {
    	...
    	let chatmessage1;
    	let current;
    	searchselect = new SearchSelect({ $$inline: true });

    	chatmessage0 = new ChatMessage({
    			props: { senderIsYou: true, message: "hey" },
    			$$inline: true
    		});

    	chatmessage1 = new ChatMessage({
    			props: { senderIsYou: false, message: "hey" },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h4, "class", "svelte-cvyhvo");
    			add_location(h4, file$2, 7, 4, 185);
    			attr_dev(div0, "class", "header svelte-cvyhvo");
    			add_location(div0, file$2, 6, 2, 159);
    			attr_dev(hr, "class", "svelte-cvyhvo");
    			add_location(hr, file$2, 11, 2, 241);
    			attr_dev(div1, "class", "chat svelte-cvyhvo");
    			add_location(div1, file$2, 13, 2, 253);
    			attr_dev(div2, "class", "chat-container svelte-cvyhvo");
    			add_location(div2, file$2, 5, 0, 127);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div2, t3);
    			append_dev(div2, div1);
    			mount_component(chatmessage0, div1, null);
    			append_dev(div1, t4);
    			mount_component(chatmessage1, div1, null);
    			current = true;
    		},
    		p: noop$1,
    		i: function intro(local) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ ChatMessage, SearchSelect });
    	return [];
    }
    ...
    // (51:6) <ToastContainer placement="bottom-left" let:data>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(51:6) <ToastContainer placement=\\\"bottom-left\\\" let:data>",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 21, 4, 734);
    			attr_dev(main, "class", "svelte-ssj8mr");
    			add_location(main, file, 20, 2, 723);
    		},
    		m: function mount(target, anchor) {
