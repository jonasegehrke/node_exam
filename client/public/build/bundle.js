...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	let div0;
    	let h3;
    	let t0_value = /*firstName*/ ctx[5] + " " + /*lastName*/ ctx[6] + "";
    	let t0;
    	let t1;
    	let h50;
    	let t2;
    	...
    	let p3;
    	let t15;
    	let if_block = /*showGrades*/ ctx[12] && create_if_block_1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			h50 = element("h5");
    			t2 = text(/*studentNumber*/ ctx[7]);
    			t3 = space();
    			p0 = element("p");
    			t4 = text("Klasse: ");
    			t5 = text(/*className*/ ctx[8]);
    			t6 = space();
    			if (if_block) if_block.c();
    			t7 = space();
    			hr = element("hr");
    			...
    			t10 = space();
    			p1 = element("p");
    			t11 = text(/*email*/ ctx[9]);
    			t12 = space();
    			p2 = element("p");
    			t13 = text(/*phone*/ ctx[10]);
    			t14 = space();
    			p3 = element("p");
    			t15 = text(/*address*/ ctx[11]);
    			attr_dev(h3, "id", "name");
    			attr_dev(h3, "class", "svelte-5p4yua");
    			add_location(h3, file$4, 40, 4, 750);
    			attr_dev(h50, "id", "student-number");
    			attr_dev(h50, "class", "svelte-5p4yua");
    			add_location(h50, file$4, 41, 4, 803);
    			attr_dev(p0, "id", "class");
    			attr_dev(p0, "class", "svelte-5p4yua");
    			add_location(p0, file$4, 42, 4, 853);
    			attr_dev(div0, "class", "general-info svelte-5p4yua");
    			add_location(div0, file$4, 39, 2, 718);
    			attr_dev(hr, "class", "svelte-5p4yua");
    			add_location(hr, file$4, 57, 2, 1203);
    			attr_dev(h51, "id", "contact-heading");
    			attr_dev(h51, "class", "svelte-5p4yua");
    			add_location(h51, file$4, 60, 4, 1247);
    			attr_dev(p1, "class", "svelte-5p4yua");
    			add_location(p1, file$4, 61, 4, 1290);
    			attr_dev(p2, "class", "svelte-5p4yua");
    			add_location(p2, file$4, 62, 4, 1310);
    			attr_dev(p3, "class", "svelte-5p4yua");
    			add_location(p3, file$4, 63, 4, 1330);
    			attr_dev(div1, "class", "contact-info svelte-5p4yua");
    			add_location(div1, file$4, 59, 2, 1215);
    			attr_dev(div2, "class", "card-container svelte-5p4yua");
    			add_location(div2, file$4, 38, 0, 686);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div2, anchor);
    			append_dev(div2, div0);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*firstName, lastName*/ 96 && t0_value !== (t0_value = /*firstName*/ ctx[5] + " " + /*lastName*/ ctx[6] + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*studentNumber*/ 128) set_data_dev(t2, /*studentNumber*/ ctx[7]);
    			if (dirty & /*className*/ 256) set_data_dev(t5, /*className*/ ctx[8]);

    			if (/*showGrades*/ ctx[12]) {
    				if (if_block) {
    					if_block.p(ctx, dirty);
    				} else {
    			...
    			if (dirty & /*email*/ 512) set_data_dev(t11, /*email*/ ctx[9]);
    			if (dirty & /*phone*/ 1024) set_data_dev(t13, /*phone*/ ctx[10]);
    			if (dirty & /*address*/ 2048) set_data_dev(t15, /*address*/ ctx[11]);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div2);
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "test");
    			add_location(div, file$4, 36, 1, 651);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(hr, "class", "svelte-5p4yua");
    			add_location(hr, file$4, 46, 4, 928);
    			attr_dev(h5, "id", "grades-heading");
    			attr_dev(h5, "class", "svelte-5p4yua");
    			add_location(h5, file$4, 48, 6, 968);
    			attr_dev(p0, "class", "svelte-5p4yua");
    			add_location(p0, file$4, 49, 6, 1015);
    			attr_dev(p1, "class", "svelte-5p4yua");
    			add_location(p1, file$4, 50, 6, 1044);
    			attr_dev(p2, "class", "svelte-5p4yua");
    			add_location(p2, file$4, 51, 6, 1077);
    			attr_dev(p3, "class", "svelte-5p4yua");
    			add_location(p3, file$4, 52, 6, 1112);
    			attr_dev(p4, "class", "svelte-5p4yua");
    			add_location(p4, file$4, 53, 6, 1149);
    			attr_dev(div, "class", "grades svelte-5p4yua");
    			add_location(div, file$4, 47, 4, 940);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$7(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*small*/ ctx[13]) return create_if_block$3;
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('studentNumber' in $$props) $$invalidate(7, studentNumber = $$props.studentNumber);
    		...
    		if ('showGrades' in $$props) $$invalidate(12, showGrades = $$props.showGrades);
    		...
    		if ('small' in $$props) $$invalidate(13, small = $$props.small);
    	};
    ...
    class StudentCard extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*studentNumber*/ ctx[7] === undefined && !('studentNumber' in props)) {
    			console.warn("<StudentCard> was created without expected prop 'studentNumber'");
    		}

    		if (/*className*/ ctx[8] === undefined && !('className' in props)) {
    		...
    		if (/*phone*/ ctx[10] === undefined && !('phone' in props)) {
    			console.warn("<StudentCard> was created without expected prop 'phone'");
    		}

    		if (/*address*/ ctx[11] === undefined && !('address' in props)) {
    			console.warn("<StudentCard> was created without expected prop 'address'");
    		}

    		if (/*showGrades*/ ctx[12] === undefined && !('showGrades' in props)) {
    		...
    		if (/*small*/ ctx[13] === undefined && !('small' in props)) {
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const post_changes = {};
    			if (dirty & /*$posts*/ 2) post_changes.title = /*post*/ ctx[7].title;
    			if (dirty & /*$posts*/ 2) post_changes.content = /*post*/ ctx[7].content;
    			if (dirty & /*$posts*/ 2) post_changes.creator = /*post*/ ctx[7].studentName;
    			if (dirty & /*$posts*/ 2) post_changes.timestamp = /*post*/ ctx[7].created;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(105:4) {#each $posts as post}",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button0, "class", "svelte-y86k2u");
    			add_location(button0, file$3, 91, 4, 2598);
    			attr_dev(input, "id", "title-input");
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "Titel");
    			attr_dev(input, "class", "svelte-y86k2u");
    			add_location(input, file$3, 93, 6, 2723);
    			...
    			attr_dev(textarea, "class", "svelte-y86k2u");
    			add_location(textarea, file$3, 94, 6, 2789);
    			attr_dev(button1, "id", "send-post-btn");
    			attr_dev(button1, "class", "svelte-y86k2u");
    			add_location(button1, file$3, 102, 6, 2934);
    			attr_dev(div0, "id", "create-post");
    			attr_dev(div0, "class", "hidden svelte-y86k2u");
    			add_location(div0, file$3, 92, 4, 2678);
    			attr_dev(div1, "class", "posts");
    			add_location(div1, file$3, 89, 2, 2571);
    			attr_dev(div2, "class", "student-info");
    			add_location(div2, file$3, 113, 2, 3222);
    			attr_dev(div3, "class", "container svelte-y86k2u");
    			add_location(div3, file$3, 88, 0, 2544);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 15, 0, 378);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
