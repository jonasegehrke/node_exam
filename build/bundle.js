...
var app = (function () {
    ...
    const students = writable(setStudents);
    ...
    const file$6 = "src\\pages\\Login\\Login.svelte";
    ...
    const file$4 = "src\\components\\StudentCard.svelte";
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$4, 53, 4, 1009);
    			attr_dev(p1, "class", "class svelte-1aw0yuq");
    			add_location(p1, file$4, 54, 4, 1063);
    			attr_dev(div, "class", "card-container-small svelte-1aw0yuq");
    			add_location(div, file$4, 52, 2, 937);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, p0);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(hr, "class", "svelte-1aw0yuq");
    			add_location(hr, file$4, 70, 6, 1481);
    			attr_dev(h5, "id", "grades-heading");
    			attr_dev(h5, "class", "svelte-1aw0yuq");
    			add_location(h5, file$4, 72, 8, 1525);
    			attr_dev(p0, "class", "svelte-1aw0yuq");
    			add_location(p0, file$4, 73, 8, 1574);
    			attr_dev(p1, "class", "svelte-1aw0yuq");
    			add_location(p1, file$4, 74, 8, 1605);
    			attr_dev(p2, "class", "svelte-1aw0yuq");
    			add_location(p2, file$4, 75, 8, 1640);
    			attr_dev(p3, "class", "svelte-1aw0yuq");
    			add_location(p3, file$4, 76, 8, 1677);
    			attr_dev(p4, "class", "svelte-1aw0yuq");
    			add_location(p4, file$4, 77, 8, 1716);
    			attr_dev(div, "class", "grades svelte-1aw0yuq");
    			add_location(div, file$4, 71, 6, 1495);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$7(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*small*/ ctx[5]) return create_if_block$3;
    ...
    const file$3 = "src\\pages\\Home\\Home.svelte";
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const post_changes = {};
    			if (dirty & /*$posts*/ 2) post_changes.title = /*post*/ ctx[6].title;
    			if (dirty & /*$posts*/ 2) post_changes.content = /*post*/ ctx[6].content;
    			if (dirty & /*$posts*/ 2) post_changes.creator = /*post*/ ctx[6].studentName;
    			if (dirty & /*$posts*/ 2) post_changes.timestamp = /*post*/ ctx[6].created;
    ...
    function create_fragment$6(ctx) {
    	...
    	studentcard = new StudentCard({
    			props: {
    				firstName: /*$studentData*/ ctx[0].firstName,
    				lastName: /*$studentData*/ ctx[0].lastName,
    				studentNumber: /*$studentData*/ ctx[0].studentNumber,
    				className: /*$studentData*/ ctx[0].className,
    				email: /*$studentData*/ ctx[0].email,
    				phone: /*$studentData*/ ctx[0].phone,
    				address: /*$studentData*/ ctx[0].address,
    				showGrades: true,
    				dansk: /*$studentData*/ ctx[0].dansk,
    				engelsk: /*$studentData*/ ctx[0].engelsk,
    				historie: /*$studentData*/ ctx[0].historie,
    				matematik: /*$studentData*/ ctx[0].matematik,
    				geografi: /*$studentData*/ ctx[0].geografi,
    				small: false
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button1, "click", /*handleSendPost*/ ctx[2], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$studentData*/ 1) studentcard_changes.firstName = /*$studentData*/ ctx[0].firstName;
    			if (dirty & /*$studentData*/ 1) studentcard_changes.lastName = /*$studentData*/ ctx[0].lastName;
    			if (dirty & /*$studentData*/ 1) studentcard_changes.studentNumber = /*$studentData*/ ctx[0].studentNumber;
    			if (dirty & /*$studentData*/ 1) studentcard_changes.className = /*$studentData*/ ctx[0].className;
    			if (dirty & /*$studentData*/ 1) studentcard_changes.email = /*$studentData*/ ctx[0].email;
    			if (dirty & /*$studentData*/ 1) studentcard_changes.phone = /*$studentData*/ ctx[0].phone;
    			if (dirty & /*$studentData*/ 1) studentcard_changes.address = /*$studentData*/ ctx[0].address;
    			if (dirty & /*$studentData*/ 1) studentcard_changes.dansk = /*$studentData*/ ctx[0].dansk;
    			if (dirty & /*$studentData*/ 1) studentcard_changes.engelsk = /*$studentData*/ ctx[0].engelsk;
    			if (dirty & /*$studentData*/ 1) studentcard_changes.historie = /*$studentData*/ ctx[0].historie;
    			if (dirty & /*$studentData*/ 1) studentcard_changes.matematik = /*$studentData*/ ctx[0].matematik;
    			if (dirty & /*$studentData*/ 1) studentcard_changes.geografi = /*$studentData*/ ctx[0].geografi;
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, studentData, $$value => $$invalidate(0, $studentData = $$value));
    	validate_store(userId, 'userId');
    	component_subscribe($$self, userId, $$value => $$invalidate(3, $userId = $$value));
    	...
    	return [$studentData, $posts, handleSendPost];
    }
    ...
    const file$2 = "src\\pages\\Students\\Students.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 15, 0, 375);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<Students> was created with unknown prop '${key}'`);
    	});
    ...
    function create_default_slot_6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path, file$1, 8, 95, 244);
    			attr_dev(svg, "height", "50px");
    			attr_dev(svg, "width", "100%");
    			attr_dev(svg, "viewBox", "0 0 512 512");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			add_location(svg, file$1, 8, 6, 155);
    			attr_dev(p, "class", "brand-name svelte-mns28g");
    			add_location(p, file$1, 9, 6, 959);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, svg, anchor);
    			append_dev(svg, path);
    ...
    // (18:6) <Link to="/logout" class="svelte-link">
    function create_default_slot_4$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(18:6) <Link to=\\\"/logout\\\" class=\\\"svelte-link\\\">",
    		ctx
    	});
    ...
    // (21:6) <PrivateRoute path="/" let:location>
    function create_default_slot_5(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(21:6) <PrivateRoute path=\\\"/\\\" let:location>",
    		ctx
    	});
    ...
    // (25:6) <PrivateRoute path="/students" let:location>
    function create_default_slot_4(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(25:6) <PrivateRoute path=\\\"/students\\\" let:location>",
    		ctx
    	});
    ...
    // (36:6) <ToastContainer placement="bottom-right" let:data>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(36:6) <ToastContainer placement=\\\"bottom-right\\\" let:data>",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 19, 4, 566);
    			attr_dev(main, "class", "svelte-1r97ayh");
    			add_location(main, file, 18, 2, 555);
    		},
    		m: function mount(target, anchor) {
    			if (if_block) if_block.m(target, anchor);
    			insert_dev(target, t0, anchor);
