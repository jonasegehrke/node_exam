...
if (deleteMode) {
  ...
  */
  ...
  /* 
    Seed the student_user table with 2 users
  */
  await db.run(
  ...
  */
  ...
  /* 
    Seed the teacher_classes table
  */
  ...
  */
  async function seedLessons(classId) {
    ...
    for (let i = 1; i < dates.length; i++) {
      ...
      await db.run(
        `INSERT INTO lesson(lessonSubject, lessonDate, lessonNumber, classId) VALUES (?, ?, ?, ?);`,
        [subject, dates[i], lessonNumber, classId]
      );
  ...
  */
await db.run(
  "INSERT INTO message (message, sender, reciever, messageSent) VALUES ('Wanna get a coffee?', 1, 2, '2022-05-02 12:52:00');"
);
await db.run(
  "INSERT INTO message (message, sender, reciever, messageSent) VALUES ('sorry i am at work :-(', 2, 1, '2022-05-02 12:53:00');"
);
await db.run(
  "INSERT INTO message (message, sender, reciever, messageSent) VALUES ('Wonderful day is it not?', 1, 2, '2022-05-02 12:50:00');"
);
await db.run(
  "INSERT INTO message (message, sender, reciever, messageSent) VALUES ('Yes it is', 2, 1, '2022-05-02 12:51:00');"
);
